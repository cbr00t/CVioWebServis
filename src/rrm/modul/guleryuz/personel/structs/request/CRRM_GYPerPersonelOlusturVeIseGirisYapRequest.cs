...
namespace CVioWebServis {
    public class CRRM_GYPerPersonelOlusturVeIseGirisYapRequest : CRRMMasterListRequest<CRRMR_GYPerPersonelOlusturVeIseGirisYapArg, CRRMR_GYPerPersonelOlusturVeIseGirisYapResult> {
        #region Accessors
        [DefaultValue( false )]
        ...
        public override string DefaultWSIslem {
            get { return "perPersonelOlusturVeIseGirisYap"; }
        }

        public override Type ResponseClass {
            get { return typeof( CRRM_GYPerPersonelOlusturVeIseGirisYapResponse ); }
        }
        #endregion
