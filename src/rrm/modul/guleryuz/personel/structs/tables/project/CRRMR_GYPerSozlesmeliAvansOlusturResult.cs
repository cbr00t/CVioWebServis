...
namespace CVioWebServis {
    [Serializable()]
    public class CRRMR_GYPerSozlesmeliAvansOlusturResult : CRRMResponseRecord {
        #region Accessors
        ...
        [XmlElement( "toplamFazlaMesai150" ), DefaultValue( typeof( decimal ), "0" )] public decimal ToplamFazlaMesai150 { get; set; }
